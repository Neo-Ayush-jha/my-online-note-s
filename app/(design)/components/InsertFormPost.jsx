...
const InsertFormPost = async ({ allAuthor, allTopic }) => {
    ...
    return (
        <>
            <div className=" max:w-sm p-4 bg-gray-600  border border-gray-200 rounded-lg shadow sm:p-6 justify-center">
            <h1 className='text-4xl text-center mb-3 text-white'>Insert post Here</h1>
